    ...
    draw()
    {
        ...
        for(var i = 1; i < this.tail_array.length; i++)
        {
            ...
            //else
            {
                ...
                ctx.lineTo(this.board.x + this.tail_array[i][0]*20+2 - Math.cos(convert(this.tail_array[i][2]))*yeah+clamp(Math.abs(this.appling*Math.cos(convert(this.tail_array[i][2]))),0,1),
                this.board.y + this.tail_array[i][1]*20+2 + Math.sin(convert(this.tail_array[i][2]))*yeah+clamp(Math.abs(this.appling*Math.sin(convert(this.tail_array[i][2]))),0,1))
            }
        }
